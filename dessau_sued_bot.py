...
def hole_daten():
    ...
    try:
        # ID für Dessau Süd suchen
        suche_url = "https://v6.db.transport.rest/locations?query=Dessau+Sued&results=1"
        ...
        # Abfahrten laden (In Süd ist weniger los, daher results=15 ausreichend)
        ...
        for d in departures:
            try:
                line = d.get('line', {})
                # Filter: Nur Züge/S-Bahnen, keine Busse
