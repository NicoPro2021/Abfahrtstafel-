...
def hole_daten():
    try:
        suche = requests.get("https://v6.db.transport.rest/locations?query=Rodleben&results=1", timeout=10).json()
...
if __name__ == "__main__":
    with open('rodleben.json', 'w', encoding='utf-8') as f: json.dump(hole_daten(), f, ensure_ascii=False, indent=4)
